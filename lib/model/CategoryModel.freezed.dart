...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String slug, int parent});
}
...
class _$_CategoryModel implements _CategoryModel {
  _$_CategoryModel(
      {this.id = 0, this.name = '', this.slug = '', this.parent = 0});
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, slug: $slug, parent: $parent)';
  }
...
abstract class _CategoryModel implements CategoryModel {
  factory _CategoryModel(
      ...
      final String name,
      final String slug,
      final int parent}) = _$_CategoryModel;
